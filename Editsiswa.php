...
<head>
  <title> SMKN SMK Sirotol Mustaqim </title>
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"> SMK Sirotol Mustaqim </img></a>
    </div>
          ...
          <form method="POST" action="prosesedit.php">
            ...
            <table border="0" class="table-responsive">
              ...
              <tr>
                ...
                <td> <input type="text" name="NIS" class="form-control input-lg" value="<?php echo $data['NIS']; ?>">
                  </input> </td>
              </tr>
              <tr>
                <td>
                ...
                <td> <input type="text" name="nama" class="form-control input-lg"
                    value="<?php echo $data['Namalengkap']; ?>"> </td>
              </tr>
              <tr>
                <td>
                  <h3> Kelas </h3>
              ...
              <tr>
                <td colspan="3" style="text-align:right"> <button type="submit" name="edit" class="btn btn-info "> <i
                      class="glyphicon glyphicon-plus"> </i> Simpan </button> </td>
              </tr>
            </table>
          </form>

...
<nav class="navbar navbar-inverse navbar-fixed-bottom">
  <ul class="nav navbar-nav">
    <li> <a> <span class="glyphicon glyphicon-globe"></span> www.Smksirotolmustaqim.sch.id </a> </li>
    <li> <a> <span class="glyphicon glyphicon-envelope"></span> humas@smksirotolmustaqim.sch.id </a> </li>
    <li> <a> <img src="../img/ig2.png" style="width:4%;"> </img> Smksirotolmustaqim </a> </li>
  </ul>
  <ul class="nav navbar-nav navbar-right">
...
<body>
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="../img/gerbang.png" alt="Chicago" style="width:100%;">
      </div>
